...
import { mixWithWhite, romanize } from "@/lib/helpers";
import { artVariants } from "@/lib/animations";
...
function toShiny(url: string): string {
  if (url.startsWith("/sprites/art/"))
    return url.replace("/sprites/art/", "/sprites/art-shiny/");
